...
class DatasetBase:
    ...
    def __init__(self, train_x=None, train_u=None, val=None, test=None, open_world=None, num_classes=None, clean_data=False, open_set=False):
        ...
        else: # open-world setting, giving wrong labels for training data
    ...
    def construct_noise_data(self, data_source):
        ...
        # Randomly select 100 categories and let all the data corresponding to them be used as noise data; the remaining noise data are randomly selected
